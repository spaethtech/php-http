...
namespace SpaethTech\HTTP\Twig\TokenParsers;

use SpaethTech\HTTP\Twig\Nodes\SwitchNode;
        ...
        while (!$end) {
            ...
            switch ($next->getValue()) {
                ...
                case 'endswitch':
                    ...
                    break;
                default:
                    throw new \Twig_Error_Syntax(sprintf('Unexpected end of template. Twig was looking for the following tags "case", "default", or "endswitch" to close the "switch" block started at line %d)', $line), -1);
            }
        }
